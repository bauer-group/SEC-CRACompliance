...
**Root Cause:**
[Detailed technical analysis of the root cause of the vulnerability]

**How the vulnerability was introduced:**
[e.g. Coding error, third-party component, configuration error, design weakness]

**When the vulnerability was introduced:**
[Version / date of introduction]

**Why it was not detected earlier:**
[e.g. Not covered by automated scans, new attack vector]
