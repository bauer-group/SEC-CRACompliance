...
|-------|----------|-----------|----------|
| Actively exploited vulnerability | **24h** early warning | ENISA / CSIRT | [Early Warning](/en/templates/enisa-early-warning) |
| Vulnerability update | **72h** notification | ENISA / CSIRT | [Notification](/en/templates/enisa-notification) |
| Final report | **14 days** | ENISA / CSIRT | [Final Report](/en/templates/enisa-final-report) |
| Severe security incident | **24h** early warning | ENISA / CSIRT | [Incident Report](/en/templates/incident-report) |
| User notification | **Without delay** | Affected users | [Vulnerability Report](/en/templates/vulnerability-report) |
