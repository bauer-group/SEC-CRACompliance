...
|----------|-----------------|------------------|
| EU Declaration of Conformity | **10 years** after placing on the market | This repository |
...
- Electronically via this repository
...
- Substantial changes to the product (new version with modified security functions)
- Changes to applied standards
- Changes to Regulation (EU) 2024/2847 (Delegated/Implementing Acts)
- Expiry of the assessment period (in the case of external assessment)
