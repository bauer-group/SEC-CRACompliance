...
Class I products may be assessed via [Internal control (Module A)](/en/conformity/self-assessment) where harmonised standards are applied in full. Without harmonised standards, an [EU type examination (Module B+C)](/en/conformity/module-bc) is required.
...
Class II products require mandatory third-party assessment: [EU type examination (Module B+C)](/en/conformity/module-bc) or [Comprehensive quality assurance (Module H)](/en/conformity/module-h).
...
- [Internal control (Module A) -- Self-assessment](/en/conformity/self-assessment)
- [EU type examination (Module B+C)](/en/conformity/module-bc)
- [Comprehensive quality assurance (Module H)](/en/conformity/module-h)
- [European cybersecurity certificate (EUCC)](/en/conformity/eucc)
...
::: tip RECOMMENDATION
The relevance assessment should be carried out individually for each BAUER GROUP product line and documented in the respective [Product Description](/en/technical-documentation/product-description). The assessment in the table above serves as initial guidance.
:::

::: warning KEEP THIS LIST UPDATED
...
4. **Document** -- Record the classification in the [Product Description](/en/technical-documentation/product-description)
5. **Risk assessment** -- Create a [Risk Assessment](/en/templates/risk-assessment) for each classified product
