...
- **Art. 19** -- [进口商义务](/zh/overview/importer-obligations)
- **Art. 20** -- [分销商义务](/zh/overview/distributor-obligations)
- **Art. 22** -- [实质性修改](/zh/overview/substantial-modifications)（未承担制造商义务）
- **Art. 32** -- 合格评定（未正式执行）
