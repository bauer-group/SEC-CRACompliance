...
在 **11.12.2027 之前**投放市场的含数字元素的产品，仅在自该日期起经历**实质性修改 (Substantial Modification)** 时才受 CRA 要求的约束。因此，既有产品受既有保护（Grandfathering，不在适用范围内），仅在 11.12.2027 当日或之后发生实质性修改时才进入适用范围。
