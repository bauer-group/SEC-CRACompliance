...
| BAUER GROUP 作为进口商 | 适用 Art. 19 项下的进口商义务（验证 CE + 文档） |
...
| 角色 | 职责 | CRA 参考 |
|------|----------------|---------------|
| **安全负责人** | CRA 合规的总体责任，ENISA 通知，事件响应 | Art. 13, Art. 14 |
| **产品负责人** | 产品分类，支持期，用户信息 | Art. 13(8), Annex II |
| **DevOps 负责人** | SBOM 生成，签名，CI/CD 流水线维护 | Annex I 第二部分 (7), Annex I 第二部分 (1) |
| **开发团队** | 安全设计，漏洞修复，代码审查 | Art. 13(1) |
| **质量保证 / 发布经理** | 合格评定，发布审批 | Annex VII |
| **管理层** | 资源分配，升级决策 | Art. 13(3) |
