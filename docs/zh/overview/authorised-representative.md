...
Art. 18 CRA 允许在欧盟境外设立的制造商指定一名在欧盟境内设立的**授权代表 (Authorised Representative)** 代表其执行特定任务。授权代表作为主管机构的接口和文档联络点，但不替代制造商在产品设计和合规方面的实质性责任。

::: info 法律依据
**Art. 18 CRA：** *"制造商可通过书面委托指定授权代表。Art. 13(1)（产品设计的安全要求）规定的义务和技术文档的编制不属于委托范围。"*

**Art. 3 No. 15 CRA：** *"授权代表"是指在欧盟境内设立的、已收到制造商书面委托代表其执行特定任务的任何自然人或法人。*
:::
...
- 没有根据 Art. 19 的进口商作为欧盟主管机构的接口
- 制造商希望确保与市场监管机构沟通的正式欧盟存在

::: warning 不能替代进口商
指定授权代表**不能**替代进口商（Art. 19）的义务。如果存在单独的进口商，进口商有其自身独立的义务。如果既没有授权代表也没有进口商，主管机构无法在欧盟境内直接联系到制造商，这可能导致加强执法措施。
:::

## 1.5.3 可委托的任务（Art. 18 第2款）
...
## 1.5.7 与进口商的关系 (Art. 19)

授权代表和进口商的角色是互补但不同的：

| 方面 | 授权代表 (Art. 18) | 进口商 (Art. 19) |
|--------|--------------------------------------|---------------------|
