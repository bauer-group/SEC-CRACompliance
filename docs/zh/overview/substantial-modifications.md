...
对含数字元素产品的**实质性修改 (Substantial Modification)** 可能导致进行修改的人被视为新的**制造商**，从而必须承担 Art. 13 项下的全部制造商义务。Art. 22 CRA 定义了何时修改被视为"实质性的"以及由此产生的后果。

实质性修改同时也是使在 11.12.2027 之前投放市场的产品首次进入 CRA 适用范围的触发因素（Art. 69 过渡条款，参见[适用范围](/zh/overview/scope)）。

::: info 法律依据
**Art. 22 CRA：** *对已投放市场的含数字元素产品进行实质性修改的任何自然人或法人，应被视为本法规意义上的制造商。*

**Art. 3 No. 30 CRA：** 实质性修改的定义。
:::
...
- 报告修改后产品中被积极利用的漏洞和严重事件（Art. 14）
- 遵守报告期限：预警 24小时、通知 72小时，以及最终报告 14天（漏洞）或 1个月（严重事件）
