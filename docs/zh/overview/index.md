...
::: tip AI Act 协同
包含 AI 组件的产品必须**同时**遵守 CRA 和 [EU AI Act (Regulation 2024/1689)](/zh/overview/nis2-integration)。CRA 涵盖产品的网络安全；AI Act 涵盖安全、透明度和权利。AI Act Art. 8(2) 允许将 CRA 合规活动整合到 AI Act 合规流程中。
:::

::: danger 从这里开始
不确定 CRA 是否适用于您的产品？使用**[适用性检查](/zh/overview/scope-checker)**获取交互式决策指导 — 从适用性到产品分类再到正确的合规路径。
:::
...
| **实施法案** | 重要及关键产品的技术描述 | 已于 2025-11-28 通过（CRA 第 7、8 条） |
| **授权法案** | CSIRT 延迟通知传播 | 已于 2025-12-11 通过（CRA 第 14 条），异议期进行中 |
| **EUCC 合规推定授权法案** | 通过 EUCC 方案的合规推定 | 预计 2026 年第四季度 |
| **标准化请求 M/606** | 41 项协调标准（15 项水平 + 26 项垂直） | 2025 年 4 月接受；2026-10-30 前交付 |
| **ENISA 统一报告平台** | CRA 第 14 条 | 中央报告平台；2026-09-11 起运行（开发中） |
