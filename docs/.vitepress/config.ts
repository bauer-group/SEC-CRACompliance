...
const baseUrl = 'https://cra.docs.bauer-group.com'
...
export default defineConfig({
  ...
  vite: {
    plugins: [
      RssPlugin({
        title: 'CRA Compliance – BAUER GROUP (Deutsch)',
        baseUrl,
        copyright: `© ${new Date().getFullYear()} BAUER GROUP`,
        description: 'Cyber Resilience Act – Compliance-Dokumentation Updates',
        language: 'de',
      ...
      RssPlugin({
        title: 'CRA Compliance – BAUER GROUP (English)',
        baseUrl,
        copyright: `© ${new Date().getFullYear()} BAUER GROUP`,
        description: 'Cyber Resilience Act – Compliance Documentation Updates',
        language: 'en',
        author: { name: 'BAUER GROUP', link: baseUrl },
      ...
      RssPlugin({
        title: 'CRA Compliance – BAUER GROUP (中文)',
        baseUrl,
        copyright: `© ${new Date().getFullYear()} BAUER GROUP`,
        description: '网络弹性法案 – 合规文档更新',
        language: 'zh',
        author: { name: 'BAUER GROUP', link: baseUrl },
