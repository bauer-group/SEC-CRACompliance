      ...
      '/en/overview/': [
        {
          ...
          items: [
            ...
            { text: '🔍 Scope Checker', link: '/en/overview/scope-checker' },
      ...
      '/en/compliance-matrix/': [
        {
          ...
          items: [
            ...
            { text: '8.2 Automation Workflows', link: '/en/compliance-matrix/automation-workflows' },
            { text: '8.3 cra-check CLI', link: '/en/compliance-matrix/cra-check' },
          ]
        }
      ],
      '/en/templates/': [
        {
          ...
          items: [
            ...
            { text: 'A.10 Product Classification Record', link: '/en/templates/product-classification-record' },
          ]
        }
      ],
    },
