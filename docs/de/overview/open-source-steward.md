...
**Art. 25 CRA:** Sicherheitsattestierung für freie und quelloffene Software.
:::
...
### 2. Schwachstellenbehandlung (Art. 24 Abs. 1)
...
### 3. Kooperation mit Behörden (Art. 24 Abs. 2)
...
| **OSS-Steward** (Organisation) | Art. 24-25 Pflichten | Eingeschränkte Pflichten (s. oben) |
| **Hersteller von OSS** (kommerziell) | Voller Hersteller (Art. 13) | Volle Herstellerpflichten |
...
|---------|------------------|
| Nicht-Erfüllung der Art. 24 Pflichten | Bis zu 5 Mio. EUR oder 1% des Jahresumsatzes |
...
- Die EU-Kommission wird **Implementing Acts** erlassen, die die Sicherheitsattestierung (Art. 25) näher spezifizieren
