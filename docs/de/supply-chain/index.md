...
**Art. 13 Abs. 5 CRA:** *„Der Hersteller übt bei der Integration von Komponenten, die von Dritten stammen, die gebotene Sorgfalt aus, um sicherzustellen, dass diese Komponenten die Sicherheit des Produkts nicht beeinträchtigen."*
...
| **5.4** | [Wirtschaftsakteur-Identifizierung (Art. 23)](/de/supply-chain/economic-operator-identification) | Rückverfolgbarkeit in der Lieferkette |
