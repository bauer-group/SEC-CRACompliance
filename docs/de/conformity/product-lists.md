...
Produkte der Klasse I können bei vollständiger Anwendung harmonisierter Normen über [Interne Kontrolle (Modul A)](/de/conformity/self-assessment) bewertet werden. Ohne harmonisierte Normen ist eine [EU-Baumusterprüfung (Modul B+C)](/de/conformity/module-bc) erforderlich.
...
Produkte der Klasse II erfordern zwingend eine Bewertung durch Dritte: [EU-Baumusterprüfung (Modul B+C)](/de/conformity/module-bc) oder [Umfassende Qualitätssicherung (Modul H)](/de/conformity/module-h).
...
- [Interne Kontrolle (Modul A) -- Selbstbewertung](/de/conformity/self-assessment)
- [EU-Baumusterprüfung (Modul B+C)](/de/conformity/module-bc)
- [Umfassende Qualitätssicherung (Modul H)](/de/conformity/module-h)
- [Europäisches Cybersicherheitszertifikat (EUCC)](/de/conformity/eucc)
...
::: tip EMPFEHLUNG
Die Relevanzeinschätzung sollte für jede Produktlinie von BAUER GROUP individuell durchgeführt und in der jeweiligen [Produktbeschreibung](/de/technical-documentation/product-description) dokumentiert werden. Die Einschätzung in der obigen Tabelle dient als initiale Orientierung.
:::

::: warning AKTUALISIERUNGSPFLICHT
...
4. **Dokumentieren** -- Halten Sie die Klassifizierung in der [Produktbeschreibung](/de/technical-documentation/product-description) fest
5. **Risikobewertung** -- Erstellen Sie eine [Risikobewertung](/de/templates/risk-assessment) für jedes klassifizierte Produkt
